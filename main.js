...
(function () {
    ...
    window.onload = function () {
       // document.getElementById("totalRecords").addEventListener("blur", getRecordsPerPageCount);
       // document.getElementById("totalPg").addEventListener("blur", getRecordsPerPageCount);
        changePage(1);
    };
    ...
    function populate_checkBox(headerPosition)
    {
        ...
        // filter --it create new array that passes the condition/test given by mentioned function
        ...
        if (flag >= 1 || dd_item.length>=1) {
            ...
            for (var j = 0; j < dd_item.length; j++) {
                if (j == 0)
                    dd_list.push(dd_item[j].getElementsByTagName('td')[headerPosition].innerHTML.trim());
                else {
                    if (dd_list.indexOf(dd_item[j].getElementsByTagName('td')[headerPosition].innerHTML.trim()) == -1) {
                        dd_list.push(dd_item[j].getElementsByTagName('td')[headerPosition].innerHTML.trim());
                    }
                }
            }
            ...
            for (var k = 0; k < dd_list.length; k++) {
                ...
                label.appendChild(document.createTextNode(dd_list[k]));
  ...
  function searchFunction_SNO(headerPositin) {
      ...
      for (var j = 1; j < tr.length-1; j++) {
          if (j == 0)
              unq_lst.push(tr[j].getElementsByTagName("td")[headerPositin].innerHTML.trim());
          else {
              if (unq_lst.indexOf(tr[j].getElementsByTagName("td")[headerPositin].innerHTML.trim()) == -1) {
                  unq_lst.push(tr[j].getElementsByTagName("td")[headerPositin].innerHTML.trim());
              }
          }
      }
      ...
      for (i = 0; i < unq_lst.length; i++) {
       //   td1 = tr[i].getElementsByTagName("td")[headerPositin];
          
          if (unq_lst[i].toUpperCase().indexOf(filter) > -1)
              {
              ...
              var label = document.createElement('label')
              label.id = lblId;
              label.appendChild(document.createTextNode(unq_lst[i]));
              sel.appendChild(checkbox);
              sel.appendChild(label);
              sel.appendChild(document.createElement("br"));
  ...
  function sortTable(index,id){
      ...
      //var imgClass = document.getElementsByClassName("sortImg");
      //for (var i = 0; i < imgClass.length; i++) {
      //    var child = imgClass[i].childElementCount;
      //    for (var j = 0; j < child; j++) {
      //        imgClass[i].children[j].remove();
      //    }
      //}
      ...
      //var id;
      ////elem.setAttribute("src", "Image/filter.gif");
      //if (index == 0) {
      //    //document.getElementById("img_SNO").appendChild(elem);
      //    id = "img_SNO";

      //}
      //else if (index == 1) {
      //   // document.getElementById("img_ENO").appendChild(elem);
      //    id = "img_ENO";
      //}
      //else if (index == 2) {
      //   // document.getElementById("img_EName").appendChild(elem);
      //    id = "img_EName";
      //}
      //else if (index == 3) {
      //   // document.getElementById("img_ESal").appendChild(elem);
      //    id = "img_ESal";
      //}
      ...
      //if (image=="img1")
      //{
      //  if (asc_Desc_Flag_I1 % 2 == 0 || asc_Desc_Flag_I2 % 2 == 0 ||asc_Desc_Flag_I3 % 2 == 0 ||asc_Desc_Flag_I4 % 2 == 0)
      var sortImg = document.getElementById(id);
      sortImg.classList.remove("sortImg");
      sortImg.classList.add("sortImgDisplay");

      if (sortImg.src.indexOf("index")>-1)
      {
          ...
          document.getElementById(id).src = "Image/asc.bmp";
      }
      else if ( sortImg.src.indexOf("desc.bmp") > -1)
      {
              ...
              document.getElementById(id).src = "Image/asc.bmp";
             // if (index == 1) asc_Desc_Flag_I1++; else if (index == 2) asc_Desc_Flag_I2++; else if (index == 3) asc_Desc_Flag_I3++; else if (index == 4) asc_Desc_Flag_I4++;
          }
          else {
            //  var imgPos = document.getElementById("img").src.search("asc.bmp");
            //  if (imgPos != -1) {
             ...
             // }
              document.getElementById(id).src = "Image/desc.bmp";
             // if (index == 1) asc_Desc_Flag_I1++; else if (index == 2) asc_Desc_Flag_I2++; else if (index == 3) asc_Desc_Flag_I3++; else if (index == 4) asc_Desc_Flag_I4++;
          }
     // }
      //if (image=="img2")
  ...
  function getRecordsPerPageCount() {
      records_per_page = parseInt(document.getElementById("totalPg").value);
      total_Records = parseInt(document.getElementById("totalRecords").value);
  ...
  document.getElementById('ang_SNO').addEventListener('click', function (e) {
      //sortTable(0);
      var doc = document.getElementsByTagName("th")[0];
      var classList;
      var id;
      classList = doc.getElementsByClassName("sortImg");
      if (classList.length == 0) {
          classList = doc.getElementsByClassName("sortImgDisplay");
          id = classList[0].id;
      }
      else { id = classList[0].id; }
      sortTable(0,id);

  });
  document.getElementById('ang_ENo').addEventListener('click', function (e) {
      //sortTable(1);
      var doc = document.getElementsByTagName("th")[1];
      var classList;
      var id;
      classList = doc.getElementsByClassName("sortImg");
      if (classList.length == 0) {
    ...
    document.getElementById('ang_EName').addEventListener('click', function (e) {
        //sortTable(2);
        var doc = document.getElementsByTagName("th")[2];
        var classList;
        var id;
        classList = doc.getElementsByClassName("sortImg");
        if (classList.length == 0) {
  ...
  document.getElementById('ang_ESal').addEventListener('click', function (e) {
      //sortTable(3);
      var doc = document.getElementsByTagName("th")[3];
      var classList;
      var id;
      classList = doc.getElementsByClassName("sortImg");
      if (classList.length == 0) {
  ...
  //document.getElementById("btn_RecordsCount").addEventListener('click', getRecordsPerPageCount);
